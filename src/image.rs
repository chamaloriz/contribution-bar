...
fn get_color(name: u8, provider: &str) -> Rgba<u8> {
    match provider {
        "gitea" => {
            match name {
                1 => Rgba([36, 80, 119, 255]),   // #245077
                2 => Rgba([49, 105, 159, 255]),  // #31699F
                3 => Rgba([65, 131, 196, 255]),  // #4183C4
                4 => Rgba([103, 156, 208, 255]), // #679CD0
                5 => Rgba([141, 181, 220, 255]), // #8DB5DC
